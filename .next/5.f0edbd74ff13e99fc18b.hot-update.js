  ...
  _createClass(faqheader, [{
    ...
    value: function renderQuestion() {
      if (this.state.category == '북클럽') {
        this.state.qnadata.map(step); // (<Question ={step.category} question={step.question} answer={step.answer}/>);
...
//# sourceMappingURL=5.f0edbd74ff13e99fc18b.hot-update.js.map