  ...
  _createClass(faqheader, [{
    ...
    value: function renderQuestion() {
      if (this.state.category == '북클럽') {
        return; // (<Question ={step.category} question={step.question} answer={step.answer}/>);
...
//# sourceMappingURL=5.aa5c9a8d6ed3d4ff579f.hot-update.js.map