  ...
  _createClass(faqheader, [{
    ...
    value: function renderQuestion() {
      if (this.state.category == '북클럽') {
        this.state.qnadata.map(); // (<Question ={step.category} question={step.question} answer={step.answer}/>);
...
//# sourceMappingURL=5.ec292bfd56b1a8b72ac3.hot-update.js.map