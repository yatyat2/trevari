  ...
  _createClass(faqheader, [{
    ...
    value: function renderQuestion() {
      if (this.state.category == '북클럽') {
        this.state.qnadata; // (<Question ={step.category} question={step.question} answer={step.answer}/>);
...
//# sourceMappingURL=5.e88e9069e705fa84acde.hot-update.js.map